    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative mb-5">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="<?= site_url('assets/img/slider4.jpg');?>" alt="">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="<?= site_url('assets/img/1.jpg');?>" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(6, 3, 21, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="<?= site_url('assets/img/2.jpg');?>" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(6, 3, 21, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="<?= site_url('assets/img/3.jpg');?>" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(6, 3, 21, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="<?= site_url('assets/img/slider2.jpg');?>" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(6, 3, 21, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="row g-5 mx-lg-0">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="<?= site_url('assets/img/about.jpg');?>" style="object-fit: cover;" alt="">
                    </div>
                </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item p-4">
                        <div class="overflow-hidden mb-4">
                            <img class="img-fluid" src="<?= site_url('assets/img/service-3.jpg');?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item p-4">
                        <div class="overflow-hidden mb-4">
                            <img class="img-fluid" src="<?= site_url('assets/img/service-5.jpg');?>" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item p-4">
                        <div class="overflow-hidden mb-4">
                            <img class="img-fluid" src="<?= site_url('assets/img/service-6.jpg');?>" alt="">
                        </div>
        ...
        <div class="container feature py-5 px-lg-0">
            <div class="row g-5 mx-lg-0">
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="<?= site_url('assets/img/feature.jpg');?>" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item p-4 my-5">
                    ...
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c1.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c2.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c3.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c4.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c5.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c6.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c7.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c8.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c9.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c10.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
                ...
                <div class="testimonial-item p-4 my-5">
                    <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                    <div class="d-flex align-items-end mb-4">
                        <img class="img-fluid flex-shrink-0" src="<?= site_url('assets/img/c11.jpg');?>" style="width: 80px; height: 80px;">
                        <div class="ms-4">
