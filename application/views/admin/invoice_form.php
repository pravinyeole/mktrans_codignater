                ...
                <div class="card-body">
                        <form method="post" action="<?= site_url('index.php/Admin/submit_invoice_form') ?>" style="margin:20px;">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="unloading">MK Invoice No.</label><spam class="imp">*</span>
                                    <input type="text" class="form-control" name="invoice_no_mk" placeholder="Please Enter MK Invoice Number" autocomplete="off" required>
                                </div>
                                <div class="col">
